    ...
    <div class="">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="x_panel">
            <div class="x_title">
              <h2>Chat Aktif<small>User Mail</small></h2>
                  ...
                  <a href="#">
                    <div class="mail_list">
                      ...
                      <div class="right">
                        ...
                        <p>Ut enim ad minim veniam, quis nostrud exercitation enim ad minim veniam,
                          quis
                ...
                <div class="col-sm-9 mail_view">
                  <div class="inbox-body">
                    <div class="mail_heading row">
                      ...
                      <div class="col-md-12">
                        <h4> Donec vitae leo at sem lobortis porttitor eu consequat risus. Mauris sed
                          congue orci. Donec ultrices faucibus rutrum.</h4>
                      </div>
                    </div>
                    ...
                    <div class="attachment">
                      <p>
                        <span><i class="fa fa-paperclip"></i> 3 Lampiran — </span>
                        <a href="#">Unduh Semua Lampiran</a> |
                        <a href="#">Lihat semua gambar</a>
                      </p>
                      <ul>
                        <li>
